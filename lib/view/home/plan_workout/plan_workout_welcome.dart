...
import 'package:brofit/common_widget/small_round_button.dart';
...
import 'package:brofit/view/home/plan_workout/plan_details.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                 ...
                 Center(child: Text('Plan your workout session and conquer your fitness goals with personalized routines tailored just for you',style:AppTextStyles.loginEnding,textAlign: TextAlign.center,)),
                  ...
                  child: Card(
                    ...
                    child: Column(
                      ...
                      children:[
                        ...
                        SizedBox(height: media.height*0.02,),
                       finaldatas.isEmpty?Text('Set Your Workout plan now',style: AppTextStyles.subtitleTextStyle(context)): Text(details!.name,style: AppTextStyles.subtitleTextStyle(context)),
                        // ,
                         SizedBox(height: media.height*0.02,),
                     finaldatas.isEmpty?   SmallRoundbutton(title: 'Add', onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (ctx)=> const AddWorkoutPlan()));
                          ...
                          // 
                          SmallRoundbutton(title: 'viewdetails', onPressed: (){
                            Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PlanDetailsPage(details: details!),
      ),
    );
                          }, buttonColor: Tcolo.Primarycolor1, textColor: Tcolo.white)
