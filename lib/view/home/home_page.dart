...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    List pages =[const MainTabView(),const PlanWorkoutWelcome(), BmiWelcome(),ProfilePage()];
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset('assets/img/appbartext (1).png',width:media.width*0.5 ,height: media.height*0.02,),
        centerTitle: true,
        elevation: 3,
      ),
